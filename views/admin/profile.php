                ...
                <div class="col-md-3">
                    ...
                    <div class="box box-primary">
                        <div class="box-body box-profile">
                            <img class="profile-user-img img-responsive img-circle" src="<?php echo base_url(); ?><?php echo $patient->user_profile_pic ?>" alt="User profile picture">
                    ...
                    <div class="box box-primary">
                        ...
                        <!-- /.box-header -->
                        <div class="box-body">
                            <strong><i class="fa fa-book margin-r-5"></i> Symptoms</strong>

                            <p class="text-muted">
                                <?php echo $patient->user_symptoms ?>
                            </p>
                            ...
                            <p class="text-muted"><?php echo $patient->user_address ?></p>
                        ...
                        <div class="col-md-9">
                            <div class="nav-tabs-custom">
                                ...
                                <div class="tab-pane" id="settings">
                                    <form class="form-horizontal" action="<?php echo base_url(); ?>admin/editprofile" enctype="multipart/form-data" method="post">
                                        <div class="form-group">
                                            <label for="inputName" class="col-sm-2 control-label">Name</label>

                                            <div class="col-sm-10">
                                                <input disabled type="email" class="form-control" id="inputName"
                                                       placeholder="Name" value="<?php echo $patient->name ?>">
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-10">
                                                <input disabled type="text" class="form-control" id="inputEmail"
                                                       placeholder="Email" value="<?php echo $patient->user_name ?>" >
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-10">
                                                <input disabled type="email" class="form-control" id="inputName"
                                                       placeholder="Name" value="<?php echo $patient->user_email ?>">
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label for="inputExperience"
                                                   class="col-sm-2 control-label">Symptoms</label>

                                            <div class="col-sm-10">
                                                <textarea class="form-control" id="inputExperience"
                                                          placeholder="Symptoms" name="symptoms"></textarea>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-10">
                                                <input type="text" class="form-control" id="inputSkills"
                                                       placeholder="Skills" name="pass" value="<?php echo $patient->user_password ?>">
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label for="inputSkills" class="col-sm-2 control-label">Previous report</label>

                                            <div class="col-sm-10">
                                                <?php
                                                    foreach ($previousreport as $reportimg) {
                                                        ?>
                                                        <a target="_blank" href="<?php echo base_url(); ?><?php echo $reportimg->url ?>"><img src="<?php echo base_url(); ?><?php echo $reportimg->url ?>" width="300"></a>
                                                        <?php
                                                    }
                                                ?>
                                            </div>
                                                ...
                                                <div class="form-group">
                                                    <label for="inputSkills" class="col-sm-2 control-label">Profile
                                                        Picture</label>

                                                    <div class="col-sm-10">
                                                        <input type="file" class="form-control" id="inputSkills"
                                                               placeholder="Profilepic" name="pic">
                                                    </div>
                                                </div>
                                        <div class="form-group">
