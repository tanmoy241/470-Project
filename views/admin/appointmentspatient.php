                        ...
                        <table id="example1" class="table table-bordered table-striped">
                            ...
                            foreach ($appointment_list as $appointment) {
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <span class="badge <?php if($appointment->status == "Approved"){echo "bg-green";}else { echo "bg-red";} ?>" style="padding: 10px"><?php echo $appointment->status ?></span>
                                    </td>
                                    <td><a href="<?php echo base_url(); ?>admin/cancelappointment/<?php echo $appointment->appointment_id ?>"><button class="btn btn-danger">Cancel Appointment</button></a> </td>
                                </tr>
