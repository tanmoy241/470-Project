                            ...
                            <table id="example1" class="table table-bordered table-striped">
                                ...
                                foreach ($doclist as $doc) {
                                    ...
                                    <tr>
                                        ...
                                        <td><?php echo $doc->user_email ?></td>
                                        <td><?php echo $doc->user_phoneno ?></td>
                                        <td><?php echo $doc->doctor_area ?></td>
                                        <td><?php echo $doc->user_address ?></td>
                                        <td><a href="<?php echo base_url(); ?>/admin/approve_doctor/<?php echo $doc->user_id ?>"><button type="button" class="btn btn-block btn-danger">Approve</button></a> </td>
                                    </tr>
