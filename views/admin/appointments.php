            ...
            <div class="row">
                <div class="col-xs-12">
                    ...
                    <div class="box-header">
                        <h3 class="box-title"><Appointments></Appointments></h3>
                    </div>
                    <!-- /.box-header -->
                    <div class="box-body">
                        <table id="example1" class="table table-bordered table-striped">
                            ...
                            foreach ($appointment_list as $appointment) {
                                ...
                                <tr>
                                    ...
                                    <td><a href="<?php echo base_url(); ?>/admin/appdetails/<?php echo $appointment->appointment_id ?>"><button  type="button" class="btn btn-block btn-primary">Details</button></a></td>
                                    <td>
                                        <a href="<?php echo base_url(); ?>/admin/approveapp/<?php echo $appointment->appointment_id ?>"><button <?php if($appointment->appointment_time == "Approved"){echo "disabled";} ?> style="float:  left;width: 49%;" type="button" class="btn btn-block btn-success">Approve</button></a>
                                        <a href="<?php echo base_url(); ?>/admin/deleteapp/<?php echo $appointment->appointment_id ?>"><button style="float:  right;width: 49%;" type="button" class="btn btn-block btn-danger">Reject</button></a>
                                    </td>
                                </tr>
