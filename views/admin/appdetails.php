                            ...
                            <tbody>
                                ...
                                foreach ($appdetails as $app) {
                                    ...
                                    <tr>
                                        ...
                                        <td><?php echo $patient->user_phoneno?></td>
                                    </tr>

                                    <tr>
                                        <td><?php echo $count++ ;?></td>
                                        <td>Patient Previous Symptoms </td>

                                        <td><?php echo $patient->user_symptoms?></td>
                                    </tr>
                                    <tr>
                                        <td><?php echo $count++ ;?></td>
                                        <td>Patient Email </td>
                                    ...
                                    <tr>
                                        <td><?php echo $count++ ;?></td>
                                        <td>Patient Previous Report </td>

                                        <td>
                                            <?php
                                                foreach ($previousreport as $reportimage){
                                            ?>
                                            <a href="<?php echo base_url(); ?><?php echo $reportimage->url ?>" target="_blank   "> <img src="<?php echo base_url(); ?><?php echo $reportimage->url ?>" width="300"/> <a/>
