            ...
            <div class="row">
                <div class="col-xs-12">
                    ...
                    <div class="box box-primary">
                        ...
                        <!-- /.box-header -->
                        <!-- form start -->
                        <form role="form" method="post" enctype="multipart/form-data" action="<?php echo base_url(); ?>/admin/insert_doctor">
                            <div class="box-body">
                                <div class="form-group">
                                    <label for="exampleInputDoctorName">Doctor Name</label>
                                    <input type="text" class="form-control" name="name" id="exampleInputEmail1" placeholder="Doctor Name">
                                </div>

                                <div class="form-group">
                                    <label for="exampleInputDoctorName">Doctor User Name</label>
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="email" id="exampleInputPassword1" placeholder="Doctor Email">
                                </div>

                                <div class="form-group">
                                    <label for="exampleInputEmail1">Doctor Password</label>
                                    <input type="password" class="form-control" name="password" id="exampleInputPassword1" placeholder="Doctor Password">
                                </div>

                                <div class="form-group">
                                    <label for="exampleInputEmail1">Doctor PhoneNO</label>
                                    <input type="number" class="form-control" name="phoneno" id="exampleInputPassword1" placeholder="Doctor PhoneNO">

                                    <p class="help-block">ex: 01980064568</p>
                                </div>

                                <div class="form-group">
                                    <label for="exampleInputEmail1">Doctor Area</label>
                                    <input type="text" class="form-control" name="area" id="exampleInputPassword1" placeholder="Doctor Area">
                                </div>

                                <div class="form-group">
                                    <label for="exampleInputEmail1">Doctor Address</label>
                                    <input type="text" class="form-control" name="address" id="exampleInputPassword1" placeholder="Doctor Address">
                                </div>

                                <div class="form-group">
                                    <label for="exampleInputEmail1">Doctor Description</label>
                                    <textarea class="form-control" name="disc" rows="3" placeholder="Enter ..."></textarea>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <p class="help-block">Add doctor profile picture</p>
                                </div>
                            </div>
                            <!-- /.box-body -->
