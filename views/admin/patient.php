                            ...
                            <table id="example1" class="table table-bordered table-striped">
                                ...
                                foreach ($patientlist as $patient) {
                                    ...
                                    <tr>
                                        ...
                                        <td><?php echo $patient->user_address ?></td>
                                        <td><a href="<?php echo base_url(); ?>/admin/delete_patient/<?php echo $patient->user_id ?>"><button type="button" class="btn btn-block btn-danger">Delete</button></a> </td>
                                    </tr>
